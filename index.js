...
console.log(printKeysAndValues(country));
// Виведе
...
function printProductDetails(obj) {
  ...
  console.log(
    obj.productName,
    obj.price,
    obj.manufacturer.companyName,
    obj.manufacturer.country
  );
  // Виводимо productName, productName, companyName та country на консоль
}
...
function addProperty(array) {
  // Додаємо нову властивість Array до прототипу Array зі значенням myProperty
